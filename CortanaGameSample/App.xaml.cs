namespace CortanaGameSample
{
    ...
    sealed partial class App
    {
        ...
        {
            Debug.WriteLine("Installing voice commands...");

            // Get voice command definition (VCD) file.
            var storageFile =
                await
                    StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///FantasyKingdomCortanaCommands.xml"));

            // Install voice commands.
            await VoiceCommandDefinitionManager.InstallCommandDefinitionsFromStorageFileAsync(storageFile);

            Debug.WriteLine("Voice commands installed.");
        }
